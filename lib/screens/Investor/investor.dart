        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              decoration: BoxDecoration(color: Color.fromARGB(255, 61, 197, 186)),
              accountName: Text('Investor'),
              accountEmail: Text(''),
 ...
 Text(
  ...
  child: Text('Invest'),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: Color.fromARGB(255, 0, 92, 99), // Custom selected item color
