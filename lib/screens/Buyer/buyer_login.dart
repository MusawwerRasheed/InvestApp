...
import 'package:investorapp/screens/Buyer/buyer.dart';
...
bool _isObscured = true; // For hiding and showing the password
 ...
 appBar: AppBar(title:Text(' '), 
     ...
     actions: [
      ...
      borderSide: BorderSide(color: Color.fromARGB(255, 152, 54, 244)
      , width: 2.0),
      ...
      , width: 2.0)),
            ...
            Center(
  child: ElevatedButton( style:ButtonStyle(backgroundColor:  MaterialStateProperty.all<Color>( Color.fromARGB(2255, 152, 54, 244))),
    onPressed:(){
Navigator.push(
      context,
